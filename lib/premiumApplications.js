export const PREMIUM_APPLICATIONS = [
  ...
  },
  {
    ...
    status: 'locked',
    features: ['Recherche mots-clés par Jerry', 'Articles optimisés', 'Suivi positions'],
  ...
  },
  {
    ...
    status: 'locked',
    features: ['Réponses automatiques par Claude', 'Gestion FAQ', 'Escalade intelligente'],
  ...
  },
  {
    ...
    status: 'locked',
    features: ['Gestion par Papin', 'Alertes trésorerie', 'Simulations'],
